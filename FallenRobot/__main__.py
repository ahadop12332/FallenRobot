...
*๏ ▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱
●(https://te.legra.ph/file/8e72930c729c67765c783.jpg) ɪ ᴀᴍ ʀᴀᴠᴇɴsᴘʏ 🦇.
🌌 ᴄᴏɴᴛʀᴏʟ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴍᴜsɪᴄ ᴇғғᴏʀᴛʟᴇssʟʏ.
ᴛʏᴘᴇ /help ᴛᴏ ᴜɴᴠᴇɪʟ ʏᴏᴜʀ ʟᴏᴠᴇ.ʟᴇᴛ's ʙᴇɪɴɢ ᴏʀᴅᴇʀ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ!.
💰 ɪ ᴄᴀɴ ᴘʀᴏᴛᴇᴄᴛ ʏᴏᴜʀ ɢʀᴏᴜᴘ ғʀᴏᴍ ᴄᴏᴘʏʀɪɢʜᴛ ᴀɴᴅ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴄʟᴏɴᴇ ᴍʏ ᴘᴏᴡᴇʀ ᴛᴏᴏ.*
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="❄ ᴀʙᴏᴜᴛ ❄", url=f"https://t.me/Team_Shinobi"),
        InlineKeyboardButton(text="✨ sᴜᴩᴩᴏʀᴛ ✨", url=f"https://t.me/{SUPPORT_CHAT}"),
    ],
    [
        InlineKeyboardButton(text="🥀 ᴅᴇᴠᴇʟᴏᴩᴇʀ 🥀", url=f"tg://user?id={OWNER_ID}"),
        InlineKeyboardButton(text="☁️ ᴄʟᴏɴᴇ ☁️", url=f"https://t.me/Clone_Raven"),
    ],
]
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAxkBAAIGPGcUgpJ9ZZp0rJjQd4V1LfeleXjNAAINFQACMC-gVEBYBLP_N9mjHgQ"
            )
